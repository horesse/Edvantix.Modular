...
namespace EDV.Framework.Web.RateLimiting;
...
public static class Extensions
{
    ...
    public static IServiceCollection AddDefaultRateLimiting(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IApplicationBuilder UseDefaultRateLimiting(this IApplicationBuilder app)
    {
    ...
    private static async ValueTask OnRejected(OnRejectedContext context, CancellationToken cancellationToken)
    {
        ...
        var problem = new ProblemDetails
        {
            ...
            Detail = "Превышен лимит запросов. Пожалуйста, повторите позже.",
