...
/// <summary>
/// Добавляет базовую трассировку вокруг выполнения заданий Hangfire.
/// </summary>
public sealed class HangfireTelemetryFilter : JobFilterAttribute, IServerFilter
{
    private const string ActivityKey = "__edv_activity";
    private static readonly ActivitySource ActivitySource = new("EDV.Hangfire");
