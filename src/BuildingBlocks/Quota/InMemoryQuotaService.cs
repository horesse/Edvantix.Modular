...
/// <summary>
/// Счётчик квот внутри процесса. Подходит для разработки и тестов; не разделяется между экземплярами,
/// поэтому лимиты применяются независимо на каждом хосте. В многозвенных развёртываниях настройте Redis.
/// </summary>
