...
/// <summary>
/// Сервис-фасад, делегирующий вызовы сфокусированным сервисам с единственной ответственностью.
/// Сохранён для обратной совместимости с существующими потребителями.
/// </summary>
...
{
    // Операции регистрации (делегируются IUserRegistrationService)
    ...
    // Операции с профилем (делегируются IUserProfileService)
    ...
    // Операции со статусом (делегируются IUserStatusService)
    ...
    // Операции с ролями (делегируются IUserRoleService)
    ...
    // Операции с паролем (делегируются IUserPasswordService)
    ...
    // Операции с правами (делегируются IUserPermissionService)
