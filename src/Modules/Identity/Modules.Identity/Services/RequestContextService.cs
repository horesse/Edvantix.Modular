...
/// <summary>
/// Предоставляет информацию о контексте HTTP-запроса через абстракцию.
/// Это позволяет обработчикам получать метаданные запроса без прямой зависимости от ASP.NET Core.
/// </summary>
