...
public sealed class GlobalExceptionHandlerTests
{
    ...
    // Регрессия для #1245: отсутствующий обязательный заголовок `tenant` проявляется как BadHttpRequestException
    // во время привязки модели и должен отображаться со своим собственным кодом статуса (400), а не общим fallback-ом 500.
    [Fact]
