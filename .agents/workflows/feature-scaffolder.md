...
You orchestrate feature delivery for Edvantix.Modular. **You do not duplicate code templates** — each phase
...
## Verify
```bash
dotnet build src/EDV.Starter.slnx && dotnet test src/Tests/{X}.Tests
